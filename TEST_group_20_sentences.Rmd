...
```{r, eval=FALSE}
output_df_20 <- data.frame(
  gddid = coordinates_df_test_group_20s$X_gddid,
  lat = coordinates_df_test_group_20s$lat,
  lon = coordinates_df_test_group_20s$lng,
  sentence = coordinates_df_test_group_20s$sentence,
  sentence_number = coordinates_df_test_group_20s$number,
  age = coordinates_df_test_group_20s$date
)
write.csv(output_df_20,"nlp_output_age.csv")
```
